    ...
    <div class="wrappper" style="margin-top:100px!important ">
        <div class="content">
                    ...
                    <div class="row" style="display:flex;margin:50px;padding:0px 150px">
                        ...
                        <p style="font-size:16px">Dr. Min Bahadur completed his bachelors degree in Dental Surgeon from Manipal College of Dental Science. He worked in different 
                        Dental Hospitals as a Pedodontistbefore joing at Smile Saver. He then started working as a Senior Pedodontistat at Smile Saver</p>
                        <p style="font-size:16px">He has a string passion and dedication towards quality of patient's treatment. And he loves childrens.</p>
