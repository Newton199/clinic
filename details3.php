    ...
    <div class="wrappper" style="margin-top:100px!important ">
        <div class="content">
                    ...
                    <div class="row" style="display:flex;margin:50px;padding:0px 150px">
                        ...
                        <p style="font-size:16px">Dr. Usha Shrestha completed her Bachelors of Dental Surgery from Kathamdanu in 2005. She's an Orthodontist.</p>
                        <p style="font-size:16px">Beside passion for dentistry, she loves travelling, exploring places and going for dental camps in the rural areas 
                        specially where the places are devoid of any medical facility. She is an avid learner and has interest in learning new things be it inside or outside dentistr. </p>
                        <p style="font-style:16px">She is at Smile Saver on Wednesday, Thrusday,and Fiday.</p>
